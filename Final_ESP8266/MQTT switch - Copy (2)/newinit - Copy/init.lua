...
stat1 = file.readline()
 if string.find(stat1,"HIGH") == 1 then
 mqtt:publish("/".. name .."/switch2/status/","1", 2, 1, function(conn)
   --         print("message published")
        end)--publisher end
 end
  if string.find(stat1,"LOW") == 1 then
 mqtt:publish("/".. name .."/switch2/status/","0", 2, 1, function(conn)
   --         print("message published")
        end)--publisher end
 end
file.close()
...
stat1 = file.readline()
 if string.find(stat1,"HIGH") == 1 then
 mqtt:publish("/".. name .."/switch3/status/","1", 2, 1, function(conn)
   --         print("message published")
        end)--publisher end
 end
  if string.find(stat1,"LOW") == 1 then
 mqtt:publish("/".. name .."/switch3/status/","0", 2, 1, function(conn)
   --         print("message published")
        end)--publisher end
 end
file.close()
...
stat1 = file.readline()
 if string.find(stat1,"HIGH") == 1 then
 mqtt:publish("/".. name .."/switch5/status/","1", 2, 1, function(conn)
   --         print("message published")
        end)--publisher end
 end
  if string.find(stat1,"LOW") == 1 then
 mqtt:publish("/".. name .."/switch5/status/","0", 2, 1, function(conn)
   --         print("message published")
        end)--publisher end
 end
end
