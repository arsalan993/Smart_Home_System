...
checkbut2 = gpio.read(D1)
checkbut3 = gpio.read(D6)
checkbut5 = gpio.read(D8)
...
function switch2()
 ...
 if (buttonStatusNew2 ~= checkbut2) then
 checkbut2 = buttonStatusNew2 
 ...
 str = " "
 if (bit.band(temp,newcheck) == 1) then
 newcheck = 0
 if (buttonStatusNew2 == 0)then
     str = "sw-off"
 elseif (buttonStatusNew2 == 1)then
     str = "sw-on"
 end
 m:publish("/"..mac.."/".. name .."/switch2/status",str, 0, 1, function(client)   end)--publisher end
  end
end
end
function switch3()
 buttonStatusNew3 = gpio.read(D6)
 if (buttonStatusNew3 ~= checkbut3) then
 checkbut3 = buttonStatusNew3
...
if bit.band(temp,newcheck) == 1 then
 newcheck = 0
 if (buttonStatusNew3 == 0)then
     str = "sw-off"
 elseif (buttonStatusNew3 == 1)then
     str = "sw-on"
 end
 m:publish("/"..mac.."/".. name .."/switch3/status",str, 0, 1, function(client) end)--publisher end
  end
end
end
...
function switch5()
 ...
 if (buttonStatusNew5 ~= checkbut5) then
 checkbut5 = buttonStatusNew5 
...
if bit.band(temp,newcheck) == 1 then
 newcheck = 0
 if (buttonStatusNew5 == 0)then
     str = "sw-off"
 elseif (buttonStatusNew5== 1)then
     str = "sw-on"
 end
 m:publish("/"..mac.."/".. name .."/switch5/status",str, 0, 1, function(client) end)--publisher end
  end
end
end
